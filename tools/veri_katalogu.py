...
def classify(locator: str, columns: Iterable[str] = (), *, table_name: str = "") -> dict:
    ...
    rules = [
        ...
        # İlan şemalarında ``imar_durumu`` alanı bulunabilir; bu nedenle ilan
        # kuralları genel parsel/imar kuralından önce değerlendirilmelidir.
        (("turkiye_arsa_ayrintili", "turkiye_konut_ayrintili", "turkiye_isyeri_ayrintili"), ("listing_observation", "listing")),
        ...
        (("arsa_mahalle_trend", "80_aylik_trend", "fiyat_trend", "emlakjet_trend", "aylik_fiyat_trendi"), ("property_market", "price_trend")),
        (("fiyat_dagilim", "emlakjet_dagilim", "kirilim"), ("property_market", "price_distribution")),
        (("arsa_mahalle_alan_segmentleri",), ("property_market", "price_distribution")),
        (("arsa_mahalle_ozet", "fiyat_ozet", "emlakjet_bolge"), ("property_market", "price_summary")),
        (("arsa_fiyat_isi_haritasi", "fiyat_isi_haritasi"), ("property_market", "price_heatmap")),
