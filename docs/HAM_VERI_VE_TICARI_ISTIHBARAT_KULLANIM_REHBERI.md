...
| `google_places_ve_yogunluk.sqlite` | `google_places_ticari_yogunluk` | 299 çıpa koridor/AVM<br>1.13M+ gerçek yorum | 81 İl Tam Kapsama | Google Maps tersine mühendislik, müşteri hacmi, puan, çalışma saatleri |
| `yemek_ve_market_teslimat_ekosistemi.sqlite` | `teslimat_depolari_darkstore`<br>`uye_restoranlar_ve_hacim` | 138 darkstore/hub<br>85 üye restoran | Türkiye Geneli & Büyükşehirler | Yemeksepeti Market, Getir, Trendyol Go depoları ve restoran sipariş hacimleri |
